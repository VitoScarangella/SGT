...
$this->title = 'CSS Generation';

?>
<script>
function reload()
{
  url = '<?=Yii::$app->urlManager->createUrl('tool/css')?>';
...
$cssProperties = Tool::parseCss($path);
print_r($cssProperties);


$url = Yii::$app->assetManager->getPublishedUrl(Yii::getAlias('@vendor/thomaspark/bootswatch')) . "/$theme/bootstrap.min.css";
