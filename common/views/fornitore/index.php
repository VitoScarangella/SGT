 ...
 * @var common\models\FornitoreSearch $searchModel
 */

$this->title = 'Fornitore';
$this->params['breadcrumbs'][] = $this->title;
?>
<script>
function reportExcel()
{
    document.location="fornitore/report-excel";
}
</script>
<div class="fornitore-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php /* echo Html::a('Create Fornitore', ['create'], ['class' => 'btn btn-success'])*/  ?>
    </p>
