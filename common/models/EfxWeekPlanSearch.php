...
/**
 * EfxWeekPlanSearch represents the model behind the search form about `common\models\EfxWeekPlan`.
 */
class EfxWeekPlanSearch extends EfxWeekPlan
{
    public function rules()
    {
        return [
            [['id', 'idKey', 'anno', 'week'], 'integer'],
            [[
