...
[
	...
	'change' => function ($url, $model, $key) {
		$options = [
			'title' => Yii::t('yii', 'Change User'),
			'aria-label' => Yii::t('yii', 'Change User'),
		];
		return Html::a('<span class="glyphicon glyphicon-user fa-2x"></span>',
                            [Yii::$app->controller->id."/change", 'id' => $key], $options);
	},
