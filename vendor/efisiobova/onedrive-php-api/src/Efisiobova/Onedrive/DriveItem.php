...
* @link      https://graph.microsoft.io/
*/
class DriveItem extends \Microsoft\Graph\Model\DriveItem
{
    /**
    ...
    */
    ...
    {
      \common\models\Tool::logd($this->_propDict);
      \common\models\Tool::log(">" . array_key_exists("id", $this->_propDict) );
