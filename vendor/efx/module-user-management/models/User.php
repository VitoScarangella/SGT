...
class User extends UserIdentity
{
	...
	*/
	...
	public function getCandelete()
	{
        ...
        return Tool::canDeleteUser($this->id);
	...
	public function beforeDelete()
	{
		...
		if ( php_sapi_name() != 'cli' )
		{
			...
			if (!Tool::canDeleteUser($this->id)) {
			$this->addError('username', UserManagementModule::t('back', "User " . $this->username . " cannot be deleted"));
				return false;
			}
		...
		$userDetails = \common\models\Userdetails::find()->where(['=', "id", $this->id])->one();
