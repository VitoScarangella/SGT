				...
				'columns' => [
					...
					*/
					[
						...
						'value'=>function(User $model){
								return $model->rolesdetails; //EFX
								//EFX return implode(', ', ArrayHelper::map($model->roles, 'name', 'description'));
							},
						'format'=>'raw',
						//EFX 'visible'=>User::hasPermission('viewUserRoles'),
					],
					/*
					[
					...
					*/
					...
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									UserManagementModule::t('back', 'Details'),
									[Yii::$app->params['user_details_update'], 'id'=>$model->id], //EFX parametro in params.php
									['class'=>'btn btn-sm btn-primary', 'data-pjax'=>0]);
							},
						'format'=>'raw',
						'visible'=>User::canRoute('userdetails/update'),
						'options'=>[
							'width'=>'10px',
						],
					],
