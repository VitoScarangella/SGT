...
//						echo 'START OF TABLE ' , $this->_tableLevel , ' ROW<br />';
                        ...
                        //EFX
                        if (isset($attributeArray['class']) && isset(\Yii::$app->params[ $attributeArray['class'] ]))
                        {
                           $sheet->getStyle($column . $row)->applyFromArray( \backend\models\Tool::buildStyle( $child->nodeName, $attributeArray['class'] ) );
                        }
                        else
                          $sheet->getStyle($column . $row)->applyFromArray( \backend\models\Tool::buildStyle( $child->nodeName, "" ) );
