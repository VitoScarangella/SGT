 ...
 */
return [
  'InvalidCheckinDate' => 'Per favore, inserire una data di checkin >= al ',
  'InvalidCheckoutDate' => 'Per favore, inserire una data di checkout  <= al ',
  'InvalidCheckinoutDate' => 'Per favore, inserire una data di  checkin  > della data di checkout',
  'RommNotAvailable' => 'Non ci sono camere disponibili nel periodo indicato. Per favore verificate la disponibilità in altre date.',
  'RommNotAvailableAfter' => 'Per favore verificate la disponibilità in altre date. Non ci sono camere disponibili dopo il',
  'RommNotAvailableBefore' => 'Per favore verificate la disponibilità in altre date. Non ci sono camere disponibili prima del',
  ...
  'State' => 'Stato',
  'Reserve' => 'Prenota',
  'Update Reserve' => 'Modifica Prenotazione',
  'Reserve' => 'Prenota',
  'Company name' => 'Ragione Sociale',
  'Tax code' => 'Codice Fiscale',
  'VAT number' => 'Partita IVA',
  'Bank Transfer Confirmation Number' => 'Identificativo pagamento con bonifico',
