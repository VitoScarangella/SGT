...
<div class="sgt-societa-index">
    <?php
        ...
        'columns' => [
            ...
            Tool::XbuildEditableColumnTextArea('societa',["width"=>"70%"]),

            //Tool::XbuildColumn('cap'), //string
            Tool::XbuildEditableColumn('cap',["width"=>"5%"]),

            //Tool::XbuildColumn('comune'), //string
            Tool::XbuildEditableColumn('comune',["width"=>"20%"]),

            //Tool::XbuildColumn('provincia'), //string
            Tool::XbuildEditableColumn('provincia',["width"=>"5%"]),
